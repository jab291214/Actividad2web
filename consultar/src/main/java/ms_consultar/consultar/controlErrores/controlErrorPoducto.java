package ms_consultar.consultar.controlErrores;
...
import ms_consultar.consultar.entidad.ErrorResponse;
import ms_consultar.consultar.entidad.Error;

@RestControllerAdvice
public class controlErrorPoducto {
    @ExceptionHandler(MethodArgumentNotValidException.class)
    public ResponseEntity<ErrorResponse> controlErrorEntidadProducto (MethodArgumentNotValidException ex){
